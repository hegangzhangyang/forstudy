...
if __name__ == '__main__':
    ...
    df_budget["取暖费"] = df_budget["取暖费标准"]
    df_budget["加班工资"] = df_budget.loc[
                            ~df_budget["职务"].isin(["部长", "副部长", "高级主管", "主管", "部长助理"]), "岗位工资"] / 21.75 * 3 * 3
    ...
    df_budget.to_sql("bdget202011", conn, if_exists="replace")
    excelFormat("2020年11月份岗位预算表.xlsx", df_budget, 9, 15, "A:BU")
