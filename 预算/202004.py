...
if __name__ == '__main__':
    ...
    df_budget = pd.read_excel("2020年4月工资标准表.xlsx").fillna(0)
    ...
    df_budget.to_sql("bdget20204", conn, if_exists="replace")
    excelFormat("2020年4月份岗位预算表.xlsx", df_budget, 9, 15, "A:BU")
